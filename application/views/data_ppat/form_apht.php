		...
		<div class="container">
			...
			<section class="content">
				<div class="box box-default">
					...
					<form action="<?php echo base_url('ppat/aktappat/save_apht') ?>" method="POST">
					<div class="box-body">
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<input type="date" name="tanggal_akta_apht" class="form-control" value="<?php echo(isset($row)) ? $row['tanggal_akta_apht'] : '' ?>" required>
								</div>
							</div>
						...
						<div class="form-group row">
							...
							<div class="form-group row">
								<div class="col-md-6">
									<label>No Akta SKMHT</label>
									<input type="text" class="form-control" name="nomor_akta_skmht" placeholder="Isi Nomor Akta" value="<?php echo(isset($row)) ? $row['nomor_akta_skmht'] : '' ?>" required>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-6">
									<label for="">Tanggal Surat Akta SKMHT</label>
									<input type="date" name="tanggal_akta_skmht" class="form-control" value="<?php echo(isset($row)) ? $row['tanggal_akta_skmht'] : '' ?>" required>
								</div>
							</div>
							...
							<div class="form-group row">
								<div class="col-md-6">
									...
									<input type="date" class="form-control" name="tanggal_perjanjian_kredit" value="<?php echo(isset($row) ? $row['tanggal_perjanjian_kredit'] : '') ?>" required>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-6">
