				...
				<div class="box-body">
					...
					<div class="form-group row">
						<div class="col-md-12">
							...
							<textarea name="template" class="form-control" id="ppat" cols="30" rows="30"><?php echo(isset($row)) ? $row['template'] : ''; ?></textarea>
						</div>
					</div>
				</div>
				<div class="box-footer">
					<button type="submit" class="btn <?php echo(isset($row)) ? 'btn-warning' : 'btn-primary' ?>" name="proses"><?php echo(isset($row)) ? 'Edit' : 'Tambah'; ?></button>
				</div>
			</form>
			</div>
		</section>
